...
/*
	Author: Ravikiran Bukkasagara <contact@ravikiranb.com>
	Modifications to original file:
	1) Added Report Descriptor
	2) Implemented CUSTOM_HID_*_FS functions.
...
{
  /* USER CODE BEGIN 0 */
  HID_ITEM_UsagePage_Vendor(0x00), 
  HID_ITEM_Usage(0x1),
  HID_ITEM_Collection(0x1), // Application
    HID_ITEM_LogicalMin(0x0),
    HID_ITEM_LogicalMax(0xff),
    HID_ITEM_ReportSize(8), // bits
    HID_ITEM_ReportCount(64),
    HID_ITEM_Usage(0x1),
    HID_ITEM_Input(0x2),
    ...
    HID_ITEM_ReportCount(1),
    HID_ITEM_Usage(0x1),
    HID_ITEM_Feature(0x2),
  HID_ITEM_EndCollection
  /* USER CODE END 0 */
};
