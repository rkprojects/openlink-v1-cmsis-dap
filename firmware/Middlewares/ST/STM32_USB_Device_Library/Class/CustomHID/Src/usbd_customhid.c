/*
	...
	1) Modified endpoint polling rate and size.
...
__ALIGN_BEGIN static uint8_t USBD_CUSTOM_HID_CfgDesc[USB_CUSTOM_HID_CONFIG_DESC_SIZ] __ALIGN_END =
{
  ...
  CUSTOM_HID_EPIN_SIZE, /*wMaxPacketSize: 64 bytes max for FS */
  0x00,
  5,          /*bInterval: Polling Interval (ms)*/
  /* 34 */
  ...
  0x03,	/* bmAttributes: Interrupt endpoint */
  CUSTOM_HID_EPOUT_SIZE,	/* wMaxPacketSize: 64 bytes max for FS  */
  0x00,
  5,	/* bInterval: Polling Interval (ms) */
  /* 41 */
} ;
