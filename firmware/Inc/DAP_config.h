 ...
 *---------------------------------------------------------------------------
	...
	Modifications:
	1) Implementation of all DAP platform specific functions and macros.
...
#define DAP_VENDOR_ID     "RavikiranB.com"
#define DAP_PRODUCT_ID    "OpenLink-V1 CMSIS-DAP"
...
// TODO - Debug Unit Cortex-M Processor Header File
...
__STATIC_INLINE uint8_t DAP_GetVendorString (char *str) {
  strcpy(str, DAP_VENDOR_ID);
  return strlen(DAP_VENDOR_ID);
}
...
__STATIC_INLINE uint8_t DAP_GetProductString (char *str) {
  strcpy(str, DAP_PRODUCT_ID);
  return strlen(DAP_PRODUCT_ID);
}
...
__STATIC_INLINE uint8_t DAP_GetSerNumString (char *str) {
  // From usbd_desc.c: Get_SerialNum
	// Return unique serial number for a device/chip.
  ...
  sprintf(str, "%X%X", (unsigned int) deviceserial0, (unsigned int) deviceserial1 >> 16);
  return strlen(str);
}
...
__STATIC_INLINE void PORT_JTAG_SETUP (void) {
  ...
  GPIO_InitStruct.Pin = GPIO_PIN_SWDCLK_TCK |
                        GPIO_PIN_SWDIO_TMS |
                        GPIO_PIN_TDI;
  ...
  HAL_GPIO_WritePin(GPIOA, GPIO_PIN_TDI, GPIO_PIN_SET);
  
  
  // Output open-drain pins.
  GPIO_InitStruct.Pin = GPIO_PIN_nRESET;
  GPIO_InitStruct.Mode = GPIO_MODE_OUTPUT_OD;
  GPIO_InitStruct.Pull = GPIO_NOPULL;
  GPIO_InitStruct.Speed = GPIO_SPEED_FREQ_LOW;
  HAL_GPIO_Init(GPIOA, &GPIO_InitStruct);
  HAL_GPIO_WritePin(GPIOA, GPIO_PIN_nRESET, GPIO_PIN_SET);
  
  // Input pins
  GPIO_InitStruct.Pin = GPIO_PIN_TDO;
...
__STATIC_FORCEINLINE void     PIN_SWDIO_OUT_ENABLE  (void) {
  ...
  GPIO_InitStruct.Pin = GPIO_PIN_SWDIO_TMS;
  GPIO_InitStruct.Mode = GPIO_MODE_OUTPUT_PP;
  GPIO_InitStruct.Pull = GPIO_NOPULL;
  GPIO_InitStruct.Speed = GPIO_SPEED_FREQ_HIGH;
  HAL_GPIO_Init(GPIOA, &GPIO_InitStruct); 
...
__STATIC_INLINE void LED_CONNECTED_OUT (uint32_t bit) {
  HAL_GPIO_WritePin(GPIOA, GPIO_PIN_LED_CONNECT, !bit);
}
...
__STATIC_INLINE void LED_RUNNING_OUT (uint32_t bit) {
  HAL_GPIO_WritePin(GPIOA, GPIO_PIN_LED_RUN, !bit);
}
...
__STATIC_INLINE void DAP_SETUP (void) {
  ...
  // Output push-pull pins.
  GPIO_InitStruct.Pin = GPIO_PIN_LED_CONNECT |
                        GPIO_PIN_LED_RUN;
  GPIO_InitStruct.Mode = GPIO_MODE_OUTPUT_PP;
  GPIO_InitStruct.Pull = GPIO_NOPULL;
  GPIO_InitStruct.Speed = GPIO_SPEED_FREQ_LOW;
